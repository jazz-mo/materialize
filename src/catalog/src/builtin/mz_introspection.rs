...
pub static MZ_CLUSTER_RESOURCE_USAGE: LazyLock<BuiltinLog> = LazyLock::new(|| BuiltinLog {
    name: "mz_cluster_resource_usage",
    schema: MZ_INTROSPECTION_SCHEMA,
    oid: oid::LOG_MZ_CLUSTER_RESOURCE_USAGE_OID,
    variant: LogVariant::Compute(ComputeLog::ResourceUsage),
    access: vec![PUBLIC_SELECT],
    ontology: Some(Ontology {
        entity_name: "cluster_resource_usage",
